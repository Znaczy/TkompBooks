...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Repeater runat="server" Id="AuthorsRepeater">
        <HeaderTemplate>
            ...
            <tr>
                <td style="width:100px"><asp:TextBox runat="server" Id="FindBox_LastName"></asp:TextBox></td>
                <td style="width:100px"><asp:TextBox runat="server" Id="FindBox_FirstName"></asp:TextBox></td>
